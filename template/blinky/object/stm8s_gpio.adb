...
S:Lstm8s_gpio.GPIO_DeInit$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[yl,yh]
F:G$GPIO_Init$0_0$0({2}DF,SV:S),Z,0,3,0,0,0
S:Lstm8s_gpio.GPIO_Init$GPIO_Mode$1_0$308({1}SC:U),B,1,2
S:Lstm8s_gpio.GPIO_Init$GPIO_Pin$1_0$0({1}SC:U),B,1,-3
S:Lstm8s_gpio.GPIO_Init$GPIOx$1_0$0({2}DG,STGPIO_struct:S),B,1,-2
S:Lstm8s_gpio.GPIO_Init$sloc0$0_1$0({2}DG,SC:U),B,1,-8
S:Lstm8s_gpio.GPIO_Init$sloc1$0_1$0({1}SC:U),B,1,-6
S:Lstm8s_gpio.GPIO_Init$sloc2$0_1$0({2}DG,SC:U),B,1,-5
F:G$GPIO_Write$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_gpio.GPIO_Write$PortVal$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_gpio.GPIO_Write$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_WriteHigh$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_gpio.GPIO_WriteHigh$PortPins$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_gpio.GPIO_WriteHigh$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_WriteLow$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_gpio.GPIO_WriteLow$PortPins$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_gpio.GPIO_WriteLow$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
S:Lstm8s_gpio.GPIO_WriteLow$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$GPIO_WriteReverse$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_gpio.GPIO_WriteReverse$PortPins$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_gpio.GPIO_WriteReverse$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_ReadOutputData$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_gpio.GPIO_ReadOutputData$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_ReadInputData$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_gpio.GPIO_ReadInputData$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_ReadInputPin$0_0$0({2}DF,:S),Z,0,1,0,0,0
S:Lstm8s_gpio.GPIO_ReadInputPin$GPIO_Pin$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_gpio.GPIO_ReadInputPin$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
F:G$GPIO_ExternalPullUpConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$NewState$1_0$332({1}:S),B,1,2
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$GPIO_Pin$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$GPIOx$1_0$0({2}DG,STGPIO_struct:S),R,0,0,[xl,xh]
...
T:Fstm8s_gpio$TIM4_struct[({0}S:S$CR1$0_0$0({1}SC:U),Z,0,0)({1}S:S$RESERVED1$0_0$0({1}SC:U),Z,0,0)({2}S:S$RESERVED2$0_0$0({1}SC:U),Z,0,0)({3}S:S$IER$0_0$0({1}SC:U),Z,0,0)({4}S:S$SR1$0_0$0({1}SC:U),Z,0,0)({5}S:S$EGR$0_0$0({1}SC:U),Z,0,0)({6}S:S$CNTR$0_0$0({1}SC:U),Z,0,0)({7}S:S$PSCR$0_0$0({1}SC:U),Z,0,0)({8}S:S$ARR$0_0$0({1}SC:U),Z,0,0)]

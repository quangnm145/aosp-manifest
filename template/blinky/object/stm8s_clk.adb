...
F:G$CLK_FastHaltWakeUpCmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_FastHaltWakeUpCmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_HSECmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_HSECmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_HSICmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_HSICmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_LSICmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_LSICmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_CCOCmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_CCOCmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_ClockSwitchCmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_ClockSwitchCmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_SlowActiveHaltWakeUpCmd$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_SlowActiveHaltWakeUpCmd$NewState$1_0$0({1}:S),B,1,-1
F:G$CLK_PeripheralClockConfig$0_0$0({2}DF,SV:S),Z,0,-2,0,0,0
S:Lstm8s_clk.CLK_PeripheralClockConfig$NewState$1_0$337({1}:S),B,1,2
S:Lstm8s_clk.CLK_PeripheralClockConfig$CLK_Peripheral$1_0$0({1}SC:U),R,0,0,[xl]
...
F:G$CLK_ClockSwitchConfig$0_0$0({2}DF,:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_ClockSwitchConfig$CLK_NewClock$1_0$345({1}SC:U),B,1,2
S:Lstm8s_clk.CLK_ClockSwitchConfig$ITState$1_0$345({1}:S),B,1,3
S:Lstm8s_clk.CLK_ClockSwitchConfig$CLK_CurrentClockState$1_0$345({1}:S),B,1,4
S:Lstm8s_clk.CLK_ClockSwitchConfig$CLK_SwitchMode$1_0$0({1}:S),B,1,-1
S:Lstm8s_clk.CLK_ClockSwitchConfig$clock_master$1_0$346({1}SC:U),R,0,0,[yl]
S:Lstm8s_clk.CLK_ClockSwitchConfig$DownCounter$1_0$346({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_clk.CLK_ClockSwitchConfig$Swif$1_0$346({1}:S),R,0,0,[xl]
F:G$CLK_HSIPrescalerConfig$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_HSIPrescalerConfig$HSIPrescaler$1_0$0({1}SC:U),B,1,-1
F:G$CLK_CCOConfig$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_CCOConfig$CLK_CCO$1_0$0({1}SC:U),B,1,-1
F:G$CLK_ITConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_clk.CLK_ITConfig$NewState$1_0$367({1}:S),B,1,2
S:Lstm8s_clk.CLK_ITConfig$CLK_IT$1_0$0({1}SC:U),R,0,0,[xl]
F:G$CLK_SYSCLKConfig$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lstm8s_clk.CLK_SYSCLKConfig$CLK_Prescaler$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_clk.CLK_SYSCLKConfig$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_clk.CLK_SYSCLKConfig$sloc1$0_1$0({1}SC:U),B,1,-1
F:G$CLK_SWIMConfig$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_SWIMConfig$CLK_SWIMDivider$1_0$0({1}:S),B,1,-1
...
S:Lstm8s_clk.CLK_GetClockFreq$clockfrequency$1_0$386({4}SL:U),R,0,0,[xl,xh,yl,yh]
S:Lstm8s_clk.CLK_GetClockFreq$clocksource$1_0$386({1}SC:U),B,1,-1
S:Lstm8s_clk.CLK_GetClockFreq$tmp$1_0$386({1}SC:U),R,0,0,[a]
S:Lstm8s_clk.CLK_GetClockFreq$presc$1_0$386({1}SC:U),R,0,0,[]
S:Lstm8s_clk.CLK_GetClockFreq$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_clk.CLK_GetClockFreq$sloc1$0_1$0({4}SL:U),B,1,-4
F:G$CLK_AdjustHSICalibrationValue$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_AdjustHSICalibrationValue$CLK_HSICalibrationValue$1_0$0({1}SC:U),B,1,-1
F:G$CLK_SYSCLKEmergencyClear$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CLK_GetFlagStatus$0_0$0({2}DF,:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_GetFlagStatus$CLK_FLAG$1_0$0({2}SI:U),B,1,-2
S:Lstm8s_clk.CLK_GetFlagStatus$statusreg$1_0$395({2}SI:U),R,0,0,[]
S:Lstm8s_clk.CLK_GetFlagStatus$tmpreg$1_0$395({1}SC:U),R,0,0,[a]
S:Lstm8s_clk.CLK_GetFlagStatus$bitstatus$1_0$395({1}:S),R,0,0,[a]
S:Lstm8s_clk.CLK_GetFlagStatus$sloc0$0_1$0({2}SI:U),B,1,-4
S:Lstm8s_clk.CLK_GetFlagStatus$sloc1$0_1$0({1}SC:U),B,1,-3
F:G$CLK_GetITStatus$0_0$0({2}DF,:S),Z,0,1,0,0,0
S:Lstm8s_clk.CLK_GetITStatus$CLK_IT$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_clk.CLK_GetITStatus$bitstatus$1_0$404({1}:S),R,0,0,[a]
F:G$CLK_ClearITPendingBit$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_clk.CLK_ClearITPendingBit$CLK_IT$1_0$0({1}SC:U),R,0,0,[a]
...
T:Fstm8s_clk$TIM4_struct[({0}S:S$CR1$0_0$0({1}SC:U),Z,0,0)({1}S:S$RESERVED1$0_0$0({1}SC:U),Z,0,0)({2}S:S$RESERVED2$0_0$0({1}SC:U),Z,0,0)({3}S:S$IER$0_0$0({1}SC:U),Z,0,0)({4}S:S$SR1$0_0$0({1}SC:U),Z,0,0)({5}S:S$EGR$0_0$0({1}SC:U),Z,0,0)({6}S:S$CNTR$0_0$0({1}SC:U),Z,0,0)({7}S:S$PSCR$0_0$0({1}SC:U),Z,0,0)({8}S:S$ARR$0_0$0({1}SC:U),Z,0,0)]
...
S:G$TIM4_GetFlagStatus$0_0$0({2}DF,:S),C,0,0
S:G$TIM4_ClearFlag$0_0$0({2}DF,SV:S),C,0,0
S:G$TIM4_GetITStatus$0_0$0({2}DF,:S),C,0,0
